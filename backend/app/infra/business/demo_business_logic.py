from app.domain.ports import BusinessContextPort
...
_INTENT_CONTEXT: dict[str, str] = {
    ...
    "DELIVERY_RISK": _DELIVERY_RISKS,
    "MEETING": _MEETING_SUPPORT,
    "GREETING": _GREETING,
}


class DemoBusinessContext(BusinessContextPort):
    """Demo business-context provider (parity with the existing prototype).

    This is replaced by real enterprise connectors in a later phase.
    """

    async def get_context(self, intent: str) -> str:
        return _INTENT_CONTEXT.get(intent, "")
